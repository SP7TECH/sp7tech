...
`React` · `Next.js` · `Vite` · `React Router` · `MUI` · `Tailwind CSS`

### Backend

`Node.js` · `Express` · `REST APIs` · `JWT` · `RabbitMQ` · `Redis`
...
`AWS` · `Docker` · `Kubernetes` · `Nginx` · `CloudFront` · `Linux`

### Engineering

`System Design` · `Distributed Systems` · `DSA` · `Performance Optimization` · `API Design` · `Microservices`

### AI

`LLM Applications` · `Prompt Engineering` · `AI Agents` · `MCP` · `AI Application Architecture`
